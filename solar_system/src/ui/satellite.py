...
class SatelliteFrame(tk.Frame):
    def __init__(self, master, row, column, sticky):
        super(SatelliteFrame, self).__init__(master=master, relief=tk.SUNKEN, borderwidth=3)
        ...
        tk.Label(master=self, text='Запуск спутника', font='bold').grid(row=0, column=0, columnspan=3)
